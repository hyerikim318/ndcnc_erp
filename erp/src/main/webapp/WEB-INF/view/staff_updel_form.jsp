...
<title>ERP 예제 ::: 수정/삭제 화면</title>
</head>
<body>

<table style="width: 70%">

<tr><td colspan="6" class="grayback">사원 정보 수정</td></tr>
...
<td>
	<input type="text" name="juminOne" maxlength="6" onkeydown="return juminCheck(event)"/>
	-
	<input type="password" name="juminTwo" maxlength="7" onkeydown="return juminCheck(event)"/>
</td>
...
<div id="bntZone">
<button type="button" id="update_bnt">수정</button>
<button type="button" id="delete_but">삭제</button>
</div>

<script>
var staffNo = "${staffNo}";
</script>
<script src="${pageContext.request.contextPath}/js/updel.js"></script>
</body>
</html>